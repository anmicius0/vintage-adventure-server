...
const app = new Elysia()
  ...
  .post(
    ...
    async ({ body }) => {
      ...
      const gemini_prompt = `
        Create a stable diffusion prompt that encapsulates the essence of the story. 
        The setting is Taiwan. 
        ...
        The color palette for the image should be "vintage," indicating a muted, nostalgic, or aged look. Please ensure this is clearly communicated in the prompt. 
        The prompt should be composed of specific vocabulary words, not sentences. 
